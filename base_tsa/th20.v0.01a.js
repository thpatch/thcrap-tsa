{
	...
	"binhacks": {
		...
		"spell_result_align_1": {
			"addr": "Rx126F4F", 
			"code": "3E C7 85 24 FF FF FF 00 00 A0 42 3E C7 85 08 FF FF FF 00 00 00 00 EB 15 3E FF 85 08 FF FF FF 3E 83 BD 08 FF FF FF 0A 0F 8D 87 06 00 00 6A 01 6A 01 8B 0D 08 E8 F6 00 E8 E5 26 F9 FF 90 90 90 90 90 90 90 90 90 90 90"
		},
		"spell_result_align_2": {
			"addr": "Rx1272C6", 
			"code": "6A 00 FF B5 28 FF FF FF 68 00 80 0E 44 8D 8D 10 FE FF FF E8 32 BE EF FF 89 85 98 FE FF FF 8B 8D A0 FE FF FF 51 8B 95 9C FE FF FF 52 83 EC 08 8B CC 68 F8 39 F2 00 E8 FF 65 EE FF 8B 85 98 FE FF FF 50 8B 0D 08 E8 F6 00 51 C7 81 F4 A1 01 00 02 00 00 00 E8 32 7C F4 FF 83 C4 18 8B 0D 08 E8 F6 00 C7 81 F4 A1 01 00 00 00 00 00 90 90 90 90 90 90"
		},
		"spell_result_align_3": {
			"addr": "Rx127567", 
			"code": "6A 00 FF B5 28 FF FF FF 68 00 80 0E 44 8D 8D 04 FE FF FF E8 91 BB EF FF 89 85 48 FE FF FF 8B 85 74 FE FF FF 50 8B 8D 70 FE FF FF 51 83 EC 08 8B CC 68 F8 39 F2 00 E8 5E 63 EE FF 8B 95 48 FE FF FF 52 A1 08 E8 F6 00 50 C7 80 F4 A1 01 00 02 00 00 00 E8 92 79 F4 FF 83 C4 18 8B 0D 08 E8 F6 00 C7 81 F4 A1 01 00 00 00 00 00 90 90 90 90 90 90"
		},
